...
# Ключевое слово raise = вызвать ошибку

# raise ValueError(' My Invalid value')
# raise ValueError()


# def get_raibow_color(color_number):
...
#         raise ValueError('Color number must be in range of 1 to 7')
